 ...
 */
public class WorkingHoursDialogFragment extends DialogFragment implements View.OnClickListener{
    ...
    public static WorkingHoursDialogFragment newInstance(String workingHrs){
        WorkingHoursDialogFragment workingHrsFragment = new WorkingHoursDialogFragment();
        workingHrsFragment.workingHrs = workingHrs;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        txtPopUpAddress.setText(workingHrs);
    }
